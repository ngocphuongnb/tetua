...
func Root(v bool) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func RootEQ(v bool) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldRoot), v))
	})
}
...
func RootNEQ(v bool) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
...
func RootIsNil() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.IsNull(s.C(FieldRoot)))
	})
}

// RootNotNil applies the NotNil predicate on the "root" field.
func RootNotNil() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		s.Where(sql.NotNull(s.C(FieldRoot)))
	})
}
