// https://github.com/Joker/jade/blob/master/cmd/jade/config.go
...
func newLayout(constName string) layout {
	...
	if writer {
		/** Tetua: Disable jade cmd io.Writer paramerter
		tpl.Bbuf = "wr io.Writer"
		tpl.Before = "buffer := &WriterAsBuffer{wr}"
		End disable jade cmd io.Writer paramerter */

		/** Tetua: Create default buffer */
		tpl.Bbuf = ""
		tpl.Before = "return func(meta *entities.Meta, wr *bufio.Writer) {\n"
		tpl.Before += "buffer := &WriterAsBuffer{wr}"
		/** Tetua: End create default buffer */
	} else if stdbuf {
	...
	/** Tetua: Return io.Writer */
	tpl.After += "}"
	/** Tetua: End return io.Writer */
	...
	/** Tetua: Create jade render return type */
	tpl.Func += " func(meta *entities.Meta, wr *bufio.Writer)"
	/** Tetua: End create jade render return type */
